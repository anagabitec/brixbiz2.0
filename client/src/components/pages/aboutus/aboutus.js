...
//Image
import bricksandmotar from "../../frontPage/images/bricksandmotar.png"
    ...
    return (
        ...
        <MDBJumbotron fluid className='aboutUsView'>
            <MDBContainer className="jumbo2">
                    <MDBMedia left className="aboutus float-right mr-3" href="#">
